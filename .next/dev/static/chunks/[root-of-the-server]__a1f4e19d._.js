    ...
    const loadFromDatabase = async ()=>{
        try {
            const [customers, products, services, tickets, quotes] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$events$2f$fqlClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["fql"].quotes.findMany({
                    fields: '*'
                })
            ]);
            console.log('Raw FQL responses:', {
                customers,
                products,
                services,
                tickets,
            ...
            if (products?.token && !products?.result) {
                try {
                    const tokenResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$Api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/products?token=${products.token}`);
            ...
            if (services?.token && !services?.result) {
                try {
                    const tokenResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$Api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/services?token=${services.token}`);
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: (()=>{
                                                            let maxDiscountProduct = data.products && data.products.length > 0 ? data.products.reduce((max, product)=>{
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                    onSubmit: async (e)=>{
                                                        ...
                                                        try {
                                                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$fqlClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["fql"].quotes.createOne(newQuote);
                                                            if (response.err) {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    (ticketForm.type === 'product' ? data.products : data.services) && Array.isArray(ticketForm.type === 'product' ? data.products : data.services) ? (ticketForm.type === 'product' ? data.products : data.services).map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: item.id,
                                                                            children: item.name
                                                                        }, item.id, false, {
                                                                            fileName: "[project]/src/widgets/bottom-sheet/index.tsx",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: !currentUser ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: myTickets.map((ticket)=>{
                                                    const item = (ticket.type === 'product' ? data.products && Array.isArray(data.products) ? data.products : [] : data.services && Array.isArray(data.services) ? data.services : []).find((i)=>i.id == ticket.itemId);
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: `p-6 rounded-2xl border transition-all hover:shadow-md ${isDarkMode ? 'bg-gray-700 border-gray-600 hover:bg-gray-650' : 'bg-gray-50 border-gray-200 hover:bg-gray-100'}`,
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex justify-between items-start mb-4",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1f4e19d._.js.map